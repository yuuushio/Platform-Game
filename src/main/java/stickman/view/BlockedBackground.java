...
public class BlockedBackground implements BackgroundDrawer {
    ...
    @Override
    public void update(double xViewportOffset, double yViewportOffset, double fh) {
        floorHeight = fh; //need to reset floor height so it doesnt scuff up on level transition
